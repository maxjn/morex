                    ...
                    <div class="offcanvas__logo">
                        <a class="offcanvas__logo_link" href="index.html">
                            ...
                            <img class="hidden dark:block"
                                src="<?= get_template_directory_uri() ?>/assets/images/logo-light.png" alt="Grocee Logo"
                                width="158" height="36">
                        </a>
                    ...
                    <nav class="offcanvas__menu">
                        <ul class="offcanvas__menu_ul">
                            ...
                            <li class="offcanvas__menu_li"><a class="offcanvas__menu_item dark:text-white"
                                    href="#about">درباره من</a>
                            </li>
                            <li class="offcanvas__menu_li"><a class="offcanvas__menu_item dark:text-white"
                                    href="#services">خدمات</a>
                            </li>
                            <li class="offcanvas__menu_li"><a class="offcanvas__menu_item dark:text-white"
                                    href="#portfolio">نمونه
                                    کار</a></li>
                            <li class="offcanvas__menu_li"><a class="offcanvas__menu_item dark:text-white"
                                    href="#blog">وبلاگ</a></li>
                            <li class="offcanvas__menu_li"><a class="offcanvas__menu_item dark:text-white"
                                    href="#contact">ارتباط با
                                    من</a>
                            </li>
                        </ul>
                        <button
