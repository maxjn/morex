...
<body class="font-rubik dark:bg-dark_primary_bg">
    ...
    <!-- Preloader start -->
    <?php if (is_front_page() && function_exists('get_field') && get_field('main_loader', 'options')) { ?>
    <div id="preloader">
        <div class="loader--border"></div>
    </div>
    <?php } ?>
    <!-- Preloader end -->
    <?php if (function_exists('get_field') && get_field('main_dark_mode', 'options')) { ?>
    ...
    if (!function_exists('elementor_theme_do_location') || !elementor_theme_do_location('header')) {
        ...
        if (function_exists('get_field') && get_field('elementor_header', 'options') &&  class_exists('\Elementor\Plugin')) {

            $template_id = get_field('selected_elementor_header', 'options');
