...
<section class="pb-[70px] lg:py-[100px]" id="blog">
    <div class="container mx-auto">
        ...
        <div class="flex justify-between items-center gap-[20px] lg:gap-[30px] mb-[55px] md:flex-wrap md:text-center">
            <div class="max-w-full <?= is_front_page() ? 'lg:max-w-[575px] ' : ''; ?>  w-full">
                <span class="text-accent1 text-[20px] lg:text-[24px] font-medium mb-[10px] lg:mb-[5px]"><?= is_front_page() ? get_theme_mod('blog_sub_title_text') : $blog_tag; ?></span>
                <h2 class="text:[28px] lg:text-[48px] font-bold font-heebo leading-[36x] lg:leading-[58px] text-[#000248] dark:text-white">
                    <?= is_front_page() ? get_theme_mod('blog_title_text') : $title; ?>
                </h2>
            </div>
