    ...
    <div
        ...
        <div class="lg:max-w-[40%] sm:max-w-[60%] xs:max-w-[85%] only-md:max-w-[40%] flex justify-end">
            <div class="relative only-xl:max-w-[70%]">
                <img class="hidden dark:block" src="<?= get_template_directory_uri() ?>/assets/images/hero-man-dark.png"
                    alt="">
                <img class="dark:hidden" src="<?= get_template_directory_uri() ?>/assets/images/hero-man.png" alt="">
                <span
                    class="absolute top-[100px] lg:top-[210px] right-[-20px] only-md:right-[-10px] only-xl:max-w-[65px] lg:max-w-[80px] xl:max-w-[105px] sm:max-w-[50px] only-md:max-w-[70px] animateUpDown"><img
                        src="<?= get_template_directory_uri() ?>/assets/images/photoshop-logo.png" alt=""></span>
                <span
                    class="absolute top-[80px] left-[-40px] md:left-[-10px] only-xl:max-w-[65px] lg:max-w-[80px] xl:max-w-[105px] sm:max-w-[50px] only-md:max-w-[70px] animateUpDown"><img
                        src="<?= get_template_directory_uri() ?>/assets/images/figma.png" alt=""></span>
                ...
                <div
                    ...
                    <div class="pl-[10px] pr-[15px]">
                        <span
                            class="block text-[20px] lg:text-[26px] font-bold text-primary dark:text-white font-heebo leading-[1]">1100+هزار</span>
                        <span class="block text-paragraph dark:text-slate-200 text-[17px]">پروژه تکمیل
                            شده</span>
                    </div>
                </div>
        ...
        <div
            ...
            <span class="text-accent1 text-[24px] font-semibold italic pb-[5px]">سلام, خوش آمدید</span>
            <h2
                class="lg:text-[60px] only-md:text-[40px] sm:text-[28px] font-bold font-heebo text-heading dark:text-white">
                علی احمدی! </h2>
            <h3 class="font-heebo font-normal text-primary dark:text-white">UX/UI دیزاینر و برنامه نویس </h3>
            <p class="lg:text-[20px] md:text-[16px] text-paragraph dark:text-slate-200 lg:mt-[18px] md:mt-[15px]">
                لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم <br> از صنعت چاپ و با استفاده از طراحان گرافیک
                است. </p>
            <div class="flex items-center gap-[18px] flex-wrap mt-[30px] sm:justify-center">
                <a href="#" class="btn outline-btn text-accent1 shrink-0">درباره من</a>
                <div class="flex items-center flex-wrap gap-[15px] sm:justify-center">
                    <span
                        class="font-heebo lg:text-[22px] md:text-[18px] font-semibold shrink-0 text-primary dark:text-white">من
                        را دنبال کنید: </span>
