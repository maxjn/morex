    ...
    <div class="container mx-auto">
        ...
        <div class="flex justify-between items-center gap-[20px] lg:gap-[30px] mb-[55px] md:flex-wrap md:text-center">
            <div class="max-w-full lg:max-w-[580px]  w-full">
                <span class="text-accent1 text-[20px] lg:text-[24px] font-medium mb-[10px] lg:mb-[5px]"><?= get_theme_mod('services_sub_title_text') ?></span>
            ...
            ?>
                ...
                <div class="shadow-[0_0_50px_0_rgba(196,206,213,0.2)] hover:shadow-[0_0_150px_0_rgba(196,206,213,0.7)]  dark:shadow-[0_0_20px_0_rgba(0,0,0,0.1)] dark:hover:shadow-[0_0_50px_0_rgba(0,0,0,0.2)] hover:translate-y-[-10px] transition duration-500">
                    <div class="overflow-hidden px-[30px] xl:px-[40px] lg:pt-[50px] md:pt-[40px] pb-[40px] ">
                        <span class="bg-[#<?= $service['service_color'] ?>] text-white w-[70px] h-[70px] lg:w-[93px] lg:h-[93px] flex items-center justify-center rounded-full service-shape before:bg-[#<?= $service['service_color'] ?>] before:opacity-[0.26]">
                        ...
                        <a href="<?= $service['service_btn_text'] ?>" class="link-button text-[#<?= $service['service_color'] ?>] before:bg-[#<?= $service['service_color'] ?>] mt-[15px] hover:text-[#333] dark:hover:text-white"><?= $service['service_btn_text'] ?></a>
                    </div>
                </div>
                <!-- Single service end -->
            <?php endforeach; ?>
