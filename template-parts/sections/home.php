...
<section
    ...
    <div
            ...
            <div class="relative only-xl:max-w-[70%]">
                ...
                <div
                    ...
                    <div class="pl-[10px] pr-[15px]">
                        <span
                            class="block text-[20px] lg:text-[26px] font-bold text-primary dark:text-white font-heebo leading-[1]"><?= get_theme_mod('home_counter_number_text') ?></span>
                        <span
                            class="block text-paragraph dark:text-slate-200 text-[17px]"><?= get_theme_mod('home_counter_label_text') ?></span>
                    </div>
                </div>
                <?php } ?>
        ...
        <div
            ...
            <span
                class="text-accent1 text-[24px] font-semibold italic pb-[5px]"><?= get_theme_mod('home_top_text') ?></span>
            <h2
            ...
            <div class="flex items-center gap-[18px] flex-wrap mt-[30px] sm:justify-center">
                <?php if (get_theme_mod('home_btn_text')) { ?> <a href="<?= get_theme_mod('home_btn_url') ?>"
                    class="btn outline-btn text-accent1 shrink-0"><?= get_theme_mod('home_btn_text') ?></a>
                <?php
                }
                ?>
                <div class="flex items-center flex-wrap gap-[15px] sm:justify-center">
                    <span
                        class="font-heebo lg:text-[22px] md:text-[18px] font-semibold shrink-0 text-primary dark:text-white"><?= get_theme_mod('home_social_text') ?></span>
                    <div class="flex items-center">
                        ...
                        <a href="<?= $btn['home_social_btn_url']; ?>"
                            class="w-[30px] h-[30px] flex items-center justify-center text-accent1 border border-accent1 transition duration-300 hover:bg-accent1 hover:text-white rounded-full<?= ($counter != 1) ? ' ltr:ml-[10px] rtl:mr-[10px]' : ''; ?>">
