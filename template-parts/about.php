    ...
    <div class="container mx-auto">
        <div class="flex justify-between sm:flex-wrap sm:flex-col-reverse">
            <div class="w-full lg:max-w-[550px]">
                <div>
                    <span
                        class="text-accent1 text-[20px] lg:text-[24px] font-medium mb-[10px] lg:mb-[5px]"><?= get_theme_mod('about_sub_title_text') ?></span>
                    <h2
                ...
                <div class="mt-[30px]">
                    ...
                    <a href="<?= get_theme_mod('about_info_btn_url') ?>"
                        class="btn solid-btn text-accent1 mt-[35px] inline-block"><?= get_theme_mod('about_info_btn_text') ?></a>
                    <?php } ?>
                </div>
            </div>
            <div class="sm:mb-[50px]">
                ...
                <div class="text-center mt-[30px]">
                    ...
                    <span
                        class="font-bold sm:text-[20px] only-md:text-[24px] lg:text-[30px] font-heebo text-primary dark:text-white"><?= get_theme_mod('about_image_bottom_text') ?></span>
                </div>
            </div>
        </div>
    </div>
