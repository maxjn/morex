    ...
    <div class="mt-10">
        ...
        <div class="mt-7">
            ...
            foreach ($comments as $comment) {
                $counter++;
            ?>
                <div class="flex gap-4 <?= ($counter != $comment_count) ? 'border-b border-gray-300  mb-7' : ' '; ?> pb-7 dark:text-slate-300">
                    <div class="w-20-fix h-fit">
                        <img src="<?= get_avatar_url($comment->comment_author) ?>" alt="" class=" rounded-full overflow-hidden " width="75" height="75">
                    </div>
                    <div>
